	...
	<main role="main" class="container my-5" style="background-image: url(../../public/assets/img/drc-map.png); background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<hr>
				<h3 class="text-center"><a href="{{ asset('assets/apps/boongo-0_0_1.apk') }}" class="text-decoration-underline">Télécharger ici la version <strong>OVERVIEW</strong> de l'appli Android</a></h3>
			</div>
		</div>
	</main>
